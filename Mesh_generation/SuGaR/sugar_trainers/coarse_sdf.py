...
def coarse_training_with_sdf_regularization(args):
    ...
    if regularize_sdf:
        ...
        regularize_sdf_only_for_gaussians_with_high_opacity = True
    ...
    if initialize_from_trained_3dgs:
        with torch.no_grad():    
            ...
            if prune_at_start:
                with torch.no_grad():
                    start_prune_mask = (nerfmodel.gaussians.get_opacity.view(-1) > start_pruning_threshold) #& (nerfmodel.gaussians.get_opacity.view(-1) < 1)
