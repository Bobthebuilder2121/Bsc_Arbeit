...
def extract_mesh_from_coarse_sugar(args):
    ...
    fg_bbox_factor = 1.  # 1.
    bg_bbox_factor = 4.  # 4.
    poisson_depth = 9 # 10 for most real scenes. 6 or 7 work well for most synthetic scenes
    vertices_density_quantile = 0.075  # 0.1 for most real scenes. 0. works well for most synthetic scenes
    decimate_mesh = True
    clean_mesh = True
