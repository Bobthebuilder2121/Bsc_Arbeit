...
if __name__ == "__main__":
    ...
    #refined_sugar_path = refined_training(refined_args) #commented out because its not needed
    ...
    if args.export_uv_textured_mesh:
        ...
        #refined_mesh_path = extract_mesh_and_texture_from_refined_sugar(refined_mesh_args) #commented out because its not needed
